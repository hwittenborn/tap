...
package_version="$(cat "makedeb/MPR.PKGBUILD" | grep '^pkgver=' | awk -F '=' '{print $2}')"

# Create and push release
git tag "v${package_version}" -am ""
git push "ssh://git@${github_url}/hwittenborn/tap" "v${package_version}"
